...
public final class Constants {
    ...
    static final String OTA_URL = "https://raw.githubusercontent.com/PixelExperience-Denniz/OTA/thirteen/%s.json";
    static final String OTA_CI_URL = "";
    static final String MAINTAINER_URL = "https://github.com/%s";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/PixelExperience-Denniz/OTA/thirteen/changelog_%s.md";
